...
<body>
    ...
    <main>
    <div id ="wrapper">
        <h1 class = "ts">定員を呼び出しますか？</h1>
        <table class = "btn1">
            <tr>

                <td> 
                    <button type="button" onclick="location.href='callComp.php'">はい</button> </td>
                <td>
                    <button type="button" onclick="location.href='index2.php'">いいえ </button></td>
